...
const SideBar = () => {
  return (
    <div className="flex flex-col bg-slate-100 ">
      <div className=" pl-3 py-4 border-t border-black">
        <Image
          src={assets.logo}
          alt="image"
          width={120}
      ...
      <div className="w-36 sm:w-80  h-screen relative py-12 border border-black">
        <Link href="/admin/addproduct" className=" w-[50%] sm:w-[80%]">
          <div className="flex items-center gap-3 border-y border-black px-3 py-2 font-medium">
